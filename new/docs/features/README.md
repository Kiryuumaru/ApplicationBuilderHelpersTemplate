...
|----------|-------------|
| [Authentication](authentication.md) | JWT auth, login, register, 2FA, passkeys, sessions |
| [Anonymous Auth](anonymous-authentication.md) | Guest mode, nullable username, account linking |
| [User Management](user-management.md) | User CRUD, roles, permissions |

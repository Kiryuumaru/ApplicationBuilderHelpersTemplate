...
namespace Presentation.WebApp.Client.FunctionalTests.Components;
...
{
    public ComponentTests(SharedTestFixture fixture, ITestOutputHelper output) : base(fixture, output)
    {
    }

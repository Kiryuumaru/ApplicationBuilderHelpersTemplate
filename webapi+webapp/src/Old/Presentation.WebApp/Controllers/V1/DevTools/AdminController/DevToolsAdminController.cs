...
using Presentation.WebApp.Controllers.V1.DevTools.AdminController.Requests;
using Presentation.WebApp.Controllers.V1.DevTools.AdminController.Responses;

namespace Presentation.WebApp.Controllers.V1.DevTools.AdminController;
    ...
    IUserRegistrationService userRegistrationService) : ControllerBase
{
    ...
    public async Task<IActionResult> MakeAdmin(Guid userId, CancellationToken cancellationToken)
    {
        ...
        await userAuthorizationService.AssignRoleAsync(
            userId,
            new Application.Server.Identity.Models.RoleAssignmentRequest(Roles.Admin.Code, null),
            cancellationToken);

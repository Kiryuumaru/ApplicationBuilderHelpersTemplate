...
using Presentation.WebApp.Server.Controllers.V1.Auth.PasskeysController.Responses;
...
namespace Presentation.WebApp.Server.Controllers.V1.Auth.PasskeysController;

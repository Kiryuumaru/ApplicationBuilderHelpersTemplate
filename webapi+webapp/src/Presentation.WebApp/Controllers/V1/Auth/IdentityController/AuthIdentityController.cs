...
using Presentation.WebApp.Controllers.V1.Auth.IdentityController.Responses;
using SharedResponses = Presentation.WebApp.Controllers.V1.Auth.Shared.Responses;
using System.ComponentModel.DataAnnotations;
using Presentation.WebApp.Controllers.V1.Auth.IdentityController.Requests;
using Presentation.WebApp.Controllers.V1.Auth.IdentityController.Responses;
using Presentation.WebApp.Controllers.V1.Auth.PasskeysController.Requests;
using Presentation.WebApp.Controllers.V1.Auth.Shared;
using Presentation.WebApp.Controllers.V1.Auth.Shared.Responses;

namespace Presentation.WebApp.Controllers.V1.Auth.IdentityController;
